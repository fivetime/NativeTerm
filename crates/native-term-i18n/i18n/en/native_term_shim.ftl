...
zmodem-cancelled-enter = Cancelled (stopped on the server too; press Enter for the prompt)
...
zmodem-no-picker-files = No file dialog on this desktop (zenity or kdialog): the Files (SFTP) window is open instead. Press Enter for the prompt.
zmodem-no-picker = No file dialog on this desktop (zenity or kdialog): use Files (SFTP) (the tab's menu). Press Enter for the prompt.
