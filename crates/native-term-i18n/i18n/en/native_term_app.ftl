...
proxy-note = The proxy is written as a ProxyCommand that NativeTerm relays (SOCKS5 and SOCKS4 let the proxy resolve the host name). Plain ssh, scp and VS Code Remote use it too. Proxies that need a user name and password aren't supported yet.
