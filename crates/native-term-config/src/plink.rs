...
pub fn code_page(charset: Option<&str>) -> Result<u32, String> {
    ...
    let known = match charset.to_ascii_lowercase().replace(['_', ' '], "-").as_str() {
        ...
        "cp437" | "ibm437" => 437,
        "euc-jp" => 20932,
        "windows-1250" | "cp1250" => 1250,
        "windows-1251" | "cp1251" => 1251,
        "windows-1253" | "cp1253" => 1253,
        "windows-1254" | "cp1254" => 1254,
        "windows-1255" | "cp1255" => 1255,
        "windows-1256" | "cp1256" => 1256,
        "windows-1257" | "cp1257" => 1257,
        "windows-1258" | "cp1258" => 1258,
        "windows-874" | "cp874" | "tis-620" => 874,
        "iso-8859-2" | "latin2" => 28592,
        "iso-8859-5" => 28595,
        "iso-8859-7" => 28597,
        "iso-8859-9" => 28599,
        "iso-8859-15" | "latin9" => 28605,
